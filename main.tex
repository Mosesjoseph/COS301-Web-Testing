...
\section{Software Architecture Specifications Partially Complied To - Bravo}
	\paragraph
	\newline
	The following technologies specified in the Architectural Requirements were implemented:
	\begin{itemize}
		\item Ember CLI
		\item PhantomJS
		\item Node.js (using NPM)
		\item Broccoli
		\item Bower
		\item QUnit for testing
	\end{itemize}
	
	Therefore, the Bravo Web team adhered to the architecture specification, and there aren't any partially complied specification.
...
\paragraph\newline 
This section outlines parts of the specification which were not implemented by Bravo Team's Web Interface.
